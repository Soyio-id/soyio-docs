...
- Códigos en el rango `4XX` indican problemas con el request por la información proporcionada (ej: un parámetro requerido fue omitido, una validación falló, etc.).
- Códigos en el rango de los `5XX` indican un error desde el lado de Soyio (aunque estos son raros).
