...
schema: true
sample: {"id":"constpl_wAspvmEr4ACDZaPUtfwjsA","name":"Consentimiento básico","version":1,"duration":"P12M3H","title":"Consentimiento general","text":"De acuerdo a los {{ terms_and_conditions }} y {{ privacy_policy }} de Soyio.","data_requirements":[{"key":"first_name","data_category":"user.name.first","data_uses":["string"]}],"data_subject":"customer","product_id":"prod_1B2M2Y8AsgTpgAmY7PhCfg","branch_id":"branch_1B2M2Y8AsgTpgAmY7PhCfg","created_at":"2024-03-20T15:30:00Z","updated_at":"2024-03-20T15:30:00Z"}
