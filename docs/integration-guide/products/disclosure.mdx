...
Este módulo incluye la verificación de identidad de tu usuario. Puedes leer más detalles de cómo Soyio realiza la verificación en nuestra [documentación sobre verificación de identidad](../concepts/verification.md).
:::
