...
- ✅ Has configurado el código REDEC de tu empresa ([configuración](./quickstart.mdx#paso-1-configura-tu-empresa-para-redec))
...
- **[Genera reportes RDC30](./reports.mdx)** - Crea reportes regulatorios para la CMF y programa reportes periódicos automáticos
- **[Configura webhooks](./configuration.mdx#webhooks)** - Recibe notificaciones cuando se registren consentimientos y se generen reportes
