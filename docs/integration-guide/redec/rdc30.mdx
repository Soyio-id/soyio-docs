...
:::info[Soporte actual]
Soyio soporta la generación de reportes `rdc30` para cumplimiento con la NCG 540 de la CMF en Chile.
:::
...
- **Encabezado**: incluye código de institución CMF (10 dígitos), identificador de archivo y fecha del reporte.
- **Detalle por registro**: cada línea representa una acción de consentimiento con su ID único, fecha/hora de consentimiento y fecha/hora de fin.
- **Campos regulatorios**: se reportan RUT consultado, medio, finalidad, objetivo y RUT del ejecutivo cuando corresponda.
- **Integridad**: cada línea cierra con un hash encriptado de 64 caracteres.
...
Activa la generación automática de reportes RDC30 desde la configuración de tu cuenta. Soyio generará un reporte automáticamente cada sábado entre las 00:00 y 01:00.
