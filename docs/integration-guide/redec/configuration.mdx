...
Los reportes semanales se generan automáticamente cada sábado después del cierre del período semanal cuando esta configuración está habilitada.
...
- [RDC31](./rdc31.mdx) - Registra accesos y genera el reporte semanal RDC31
