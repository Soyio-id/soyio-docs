...
Configura reportes periódicos automáticos semanales para cumplir con los requisitos de sincronización de la CMF. Aprende cómo en [RDC30](./rdc30.mdx#configura-la-generacion-automatica-de-reportes).
:::
