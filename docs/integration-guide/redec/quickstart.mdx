...
```json title="PATCH /api/v1/company/settings"
{
  "consent": {
    "redec_enabled": true
  }
...
Configura reportes periódicos automáticos semanales para cumplir con los requisitos de sincronización de la CMF. Aprende cómo en la [guía de reportes](./reports.mdx#reportes-periódicos-automáticos).
:::
