...
El código REDEC (numérico) es requerido para generar reportes RDC30 y RDC31 válidos. Asegúrate de usar el código correcto asignado por la CMF.
:::
...
- [RDC30](./rdc30.mdx) - Crea reportes para la CMF y programa reportes periódicos automáticos
- [RDC31](./rdc31.mdx) - Registra accesos exitosos y genera el reporte semanal de accesos bajo consentimiento
- [Configuración](./configuration.mdx) - Configura REDEC en tu cuenta con opciones avanzadas

:::tip[No olvides programar tus reportes]
Configura reportes periódicos automáticos semanales para cumplir con los requisitos de sincronización de la CMF. Aprende cómo en [RDC30](./rdc30.mdx#configura-la-generacion-automatica-de-reportes) y [RDC31](./rdc31.mdx#configura-generacion-automatica).
:::
