...
<img src="/img/ejemplo-privacy-center-dsr.png" alt="Gestión de ejercicio de derechos"/>
...
Profundiza en la [guía de gestión de consentimientos](../consent/consent-revocation.mdx).
...
const privacyCenterOptions = {
  ...
  enabledFeatures: ['ConsentManagement'], // Opcional, si no especificas features habilitas todas las funcionalidades
