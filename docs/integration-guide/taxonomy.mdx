...
- `user.account` - **Información de la Cuenta**: Datos de creación o registro de la cuenta.
  - `user.account.username` - Nombre de Usuario de la Cuenta
  - `user.account.settings` - Configuración de la Cuenta

- `user.contact` - **Datos de Contacto**: Información para contactar a un usuario.
  - `user.contact.email` - Correo Electrónico de Contacto del Usuario
  - `user.contact.phone_number` - Número de Teléfono de Contacto del Usuario
  - `user.contact.address` - Dirección de Contacto del Usuario
    - `user.contact.address.street` - Calle
    - `user.contact.address.city` - Ciudad
    - `user.contact.address.postal_code` - Código Postal
    - `user.contact.address.country` - País

- `user.behavior` - **Comportamiento Observado**: Datos sobre el comportamiento del sujeto.
  - `user.behavior.browsing_history` - Historial de Navegación
  - `user.behavior.purchase_history` - Historial de Compras

- `user.device` - **Datos del Dispositivo**: Datos relacionados con el dispositivo del usuario.
  - `user.device.ip_address` - Dirección IP
  - `user.device.cookie_id` - ID de Cookie

- `user.financial` - **Datos Financieros**: Datos de pago e historial financiero.
  - `user.financial.bank_account` - Información de la Cuenta Bancaria
  - `user.financial.credit_card` - Información de la Tarjeta de Crédito

- `user.government_id` - **Identificación Gubernamental**: Datos de identificación emitidos por el estado.
  - `user.government_id.national_identification_number` - Número de Identificación Nacional
  - `user.government_id.passport_number` - Número de Pasaporte

- `user.health_and_medical` - **Datos de Salud y Médicos**: Información médica personal.

- `user.demographic` - **Datos Demográficos**:
  - `user.demographic.age_range` - Rango de Edad
  - `user.demographic.gender` - Género
  - `user.demographic.race_ethnicity` - Raza o Etnia
