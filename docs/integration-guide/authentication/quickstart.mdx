...
Utiliza el módulo de [verificación de identidad](../disclosure/disclosure.mdx) para crear la identidad verificada del usuario en el sistema. Necesitarás que el usuario complete el flujo de verificación de identidad al menos una vez para crear su identidad verificada.
...
:::tip[Pro Tip]
Te recomendamos leer el paso a paso del módulo de [verificación de identidad](../disclosure/disclosure.mdx) para integrarlo en tu flujo de onboarding o registro en tu aplicación.
:::
