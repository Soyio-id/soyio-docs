...
- Creación de cuentas con identidades falsas o robadas
- Suplantación de identidad durante el proceso de validación
- Uso de documentos reales de terceros para validar cuentas fraudulentas
