...
Para información detallada sobre el manejo de errores, eventos de error y códigos de error específicos, consulta nuestra [guía de manejo de errores](./error-handling).
:::
