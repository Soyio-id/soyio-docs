...
Para modo embebido, revisa [Valida una identidad en modo embebido](./embedded-disclosure), donde encontrarás requisitos de CSP (`whitelisted_domains`), passkeys y troubleshooting.
