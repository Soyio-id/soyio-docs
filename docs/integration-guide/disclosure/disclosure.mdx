...
:::info
Este módulo **incluye la verificación de identidad** de tu usuario. Puedes leer más detalles de cómo Soyio realiza la verificación en la [documentación sobre verificación de identidad](./verification.md).
:::

#### Descripción detallada

Este flujo comienza con la entrega de [consentimiento](../consent/consent.mdx). El usuario verá los datos que estás solicitando y deberá confirmar su consentimiento para continuar.

Luego, [se verificará la identidad](./verification.md) del usuario. Al completar este paso, se creará una identidad con los datos verificados, que podrás consultar utilizando la API de Soyio.

Al finalizar el proceso de entrega de datos y consentimiento, se creará un [acuerdo (*Agreement*)](../main/agreement.mdx) y la evidencia asociada, que podrás utilizar para demostrar que el usuario otorgó su consentimiento libre, específico, inequívoco e informado.
...
Para comenzar, deberás definor qué datos necesitas solicitar a tus usuarios de forma obligatoria para que puedan continuar con el proceso en tu empresa. Para ello, identifica la [finalidad](../consent/concepts) que tendrá cada uno de estos datos y por cuánto tiempo los almacenarás.
...
Profundiza en estos conceptos revisando nuestra [documentación sobre consentimiento y finalidades](../consent/concepts).
:::
...
Adicionalmente, puedes escuchar eventos del proceso de [verificación de identidad](./verification.md), que se lleva a cabo durante el disclosure, para obtener detalles adicionales sobre la validación y autenticación.
...
### Configuración del módulo de disclosure
