...
Al finalizar el proceso de entrega de datos y consentimiento, se creará un [acuerdo (*Agreement*)](../main/general-concepts#agreement) y la evidencia asociada, que podrás utilizar para demostrar que el usuario otorgó su consentimiento libre, específico, inequívoco e informado.
