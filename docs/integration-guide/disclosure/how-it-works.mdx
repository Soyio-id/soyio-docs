...
Para comenzar, deberás definir qué datos necesitas solicitar a tus usuarios de forma obligatoria para que puedan continuar con el proceso en tu empresa. Para ello, identifica la [finalidad](../consent/concepts) que tendrá cada uno de estos datos y por cuánto tiempo los almacenarás.
...
Profundiza en estos conceptos revisando nuestra [documentación sobre la taxonomía](../main/taxonomy).
:::
