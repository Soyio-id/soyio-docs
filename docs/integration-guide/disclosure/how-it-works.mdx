...
Este flujo comienza con la entrega de [consentimiento](../consent/introduction). El usuario verá los datos que estás solicitando (definidos en tu [plantilla de disclosure](./templates)) y deberá confirmar su consentimiento para continuar.
