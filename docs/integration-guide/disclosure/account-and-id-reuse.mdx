...
Durante el proceso de verificación de identidad, el usuario puede elegir crear una Cuenta Soyio al finalizar la validación exitosa. Esta opción aparece como un paso opcional en el flujo de disclosure.
...
:::info[Importante]
La creación de la Cuenta Soyio es completamente opcional. Si el usuario decide no crear una cuenta, el proceso de disclosure se completa normalmente, pero deberá validar nuevamente en futuras interacciones.
:::
...
Una vez completada la validación, el usuario puede crear una Cuenta Soyio opcional que le permite reutilizar su identidad verificada con **cualquier comercio** de la red Soyio.
...
- **Historial con la empresa**: El usuario previamente validó con ese comercio
...
La pantalla "Welcome back" ofrece siempre una alternativa para repetir la validación desde cero. Esto es útil cuando el usuario quiere actualizar sus datos o simplemente no desea reutilizar la información anterior.
