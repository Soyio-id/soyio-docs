...
<img src="/img/flujo-disclosure.png" alt="Diagrama del flujo del proceso de disclosure" width="100%"/>
...
Para conocer más sobre la cuenta Soyio y la reutilización en detalle, revisa [nuestra guía al respecto](./account-and-id-reuse.mdx).
:::
