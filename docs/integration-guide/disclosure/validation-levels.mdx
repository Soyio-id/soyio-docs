...
Cuando la validación usa `validation_mode: full` (equivalente a `liveness_check: true` e `id_scan_check: true`), puedes definir el umbral mínimo de coincidencia facial para considerar exitoso el `id_match`.
