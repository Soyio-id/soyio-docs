...
Cuando la validación incluye biometría completa (`liveness_check: true` e `id_scan_check: true`), puedes definir el umbral mínimo de coincidencia facial para considerar exitoso el `id_match`.
