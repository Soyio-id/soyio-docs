...
*   **[Acuerdo (Agreement)](./general-concepts#agreement)**: El "contrato" compilado y versionado para un sujeto específico. Referencia la versión exacta del *Privacy Document* y el *Consent Template* en el momento del consentimiento.
...
- [Acuerdos (Agreements)](./general-concepts#agreement) y configuraciones legales
...
Registra el mecanismo mediante el cual se otorgó o revocó un consentimiento. Estas evidencias se generan automáticamente cada vez que se crea o modifica el consentimiento y quedan reflejadas en el [Agreement del usuario](./general-concepts#agreement).
...
- Todas las versiones del [Agreement](./general-concepts#agreement)
