...
Cada vez que el usuario realice una acción consentimiento, se **creará un registro de consentimiento mediante un token de acción** (`action_token`). Este token se puede usar para crear un registro de consentimiento en el backend y generar [evidencia del consentimiento otorgado](../concepts/agreement).
...
- **Evidencia vinculante**: Generamos trazabilidad del consentimiento otorgado mediante un [agreement y evidencia](../concepts/agreement).
...
- **Usos de datos** (`data_uses`): Las categorías específicas de uso de datos según nuestra [taxonomía](../concepts/taxonomy-and-data-management)
