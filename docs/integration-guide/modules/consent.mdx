...
3. **Consulta de permisos**: Para verificar si puedes utilizar un dato específico para una finalidad concreta, **siempre debes consultar el Agreement** y no basarte en la información del template o de las acciones de consentimiento individuales.
...
#### 5.2 Consulta de Agreements

Para verificar si puedes utilizar un dato para una finalidad específica, debes consultar el [endpoint de listado de Agreements](../../api/resources/index-agreements) filtrando por el ID de la entidad o el `user_reference`:
