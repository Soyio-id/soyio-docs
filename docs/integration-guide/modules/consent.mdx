...
Una vez que el usuario haya otorgado su(s) consentimiento(s) y tengas el `action_token`, procede de la misma manera que en el enfoque con SDK: crea el registro de consentimiento mediante el [endpoint de creación de acción de consentimiento](../../api/resources/create-consent-action.api.mdx).
