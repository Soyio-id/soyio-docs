...
El módulo de **_Consent Management_** puede funcionar en dos modos diferentes según el contexto de tu aplicación:

#### 🌐 Modo Público

**Cuándo usarlo:** Para usuarios no autenticados o cuando deseas proporcionar acceso universal a la gestión de consentimientos.

**Características:**
- No requiere autenticación previa del usuario.
- Permite que cualquier usuario gestione consentimientos asociados a su identidad.
...
3. Una vez validada su identidad, puede ver y gestionar sus consentimientos
...
**Paso 2:** Configurar el Privacy Center con el token de sesión.
...
3. Inmediatamente puede ver y gestionar sus consentimientos.
