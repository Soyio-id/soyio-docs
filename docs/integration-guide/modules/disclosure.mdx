...
Este módulo mejora tu proceso de onboarding para adaptarlo a las regulaciones más estrictas de protección de datos personales.
...
Revisa la documentación sobre [verificación de identidad](../concepts/verification.md), [consentimiento](../concepts/consent.md) y [agreements](../concepts/agreement.md) para profundizar en las características de este módulo y sus aplicaciones.
...
- **Desde el back-end:** en esta opción debes crear un Disclosure Request desde tu back-end.

:::tip[Pro Tip]
    Crea la solicitud de disclosure desde el back-end si quieres utilizar la **funcionalidad de match de parámetros**. Esta funcionalidad te permite verificar que los datos entregados por el usuario coincidan con los datos almacenados en tu sistema.
:::

- **Desde el front-end:** en esta opción debes configurar algunos parámetros e iniciar el flujo directamente desde el front-end de tu aplicación.

:::warning[Importante]
    Si deseas crear el proceso directamente desde el front-end salta este paso y avanza directamente al paso 3.
:::
...
Inicia el proceso indicando el `template_id` de la plantilla creada previamente y opcionalmente indica el o los datos con los que deseas hacer match.
...
:::warning[Importante]
Para soportar navegadores Safari, asegúrate de que el widget se inicialice solo a través de una interacción directa del usuario, como un clic, debido a las políticas de seguridad del navegador contra ventanas emergentes.
:::
