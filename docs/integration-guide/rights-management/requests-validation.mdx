...
En DSR también puedes ajustar el nivel mínimo requerido para considerar válido el `id_match` cuando usas biometría completa (`liveness_check: true` e `id_scan_check: true`).
