...
Define las variables en la plantilla utilizando *handlebars* siguiendo el siguiente formato:
...
- `signature`: Representa una firma en el documento. Debe ubicarse en el lugar donde irá la firma en el documento final.
