...
:::note
Estas reglas específicas de consentimiento solo están disponibles en el `widget de consentimiento` y no tendrán efecto en otros widgets como `PrivacyCenterBox`.
:::
