...
Crea tus plantillas de consentimiento usando la API de Soyio usando el endpoint [`POST /api/v1/consent_templates`](../../api/resources/create-consent-template.api.mdx).
