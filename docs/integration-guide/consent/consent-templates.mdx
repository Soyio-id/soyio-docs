...
:::note
Si usas duración condicional basada en eventos de negocio (por ejemplo, término de contrato u obligación legal cumplida), implementa la revocación desde backend usando [Revocación de consentimiento (iniciada por la compañía)](./consent-management.mdx#revocacion-compania).
:::
