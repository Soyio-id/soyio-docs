...
Por defecto, un template de solicitud de consentimiento se asocia a toda tu compañía. Acota el alcance a un producto o filial específica usando la opción `product_id` o `branch_id`.
