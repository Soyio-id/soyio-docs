...
Soyio almacena el estado actualizado de todos los consentimientos en un [Agreement](../main/general-concepts#agreement) por usuario. Este agreement es la fuente de verdad que determina qué permisos tiene cada usuario para el uso de sus datos.
...
- [**Agreements**](../main/general-concepts#agreement): Estado consolidado y versionado de todos los consentimientos de un usuario.
