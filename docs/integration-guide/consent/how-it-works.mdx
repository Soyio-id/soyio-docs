...
- El **componente privacy center** del SDK te permite habilitar un [portal donde tus usuarios pueden gestionar y revocar sus consentimientos de manera autónoma](./consent-revocation), cumpliendo con los requisitos de transparencia y control.
