...
El módulo de consentimiento de Soyio te permite gestionar el consentimiento de tus usuarios de manera integral y auditable. El sistema funciona a través de tres componentes principales:
...
:::tip
Puedes encontrar la documentación completa del SDK de Soyio en nuestro [GitHub](https://github.com/Soyio-id/soy-io-widget).
:::
...
Revisa la [documentación completa](../../api/webhooks) de los webhooks si quieres conocer más sobre cómo configurar y suscribirte a los webhooks.
...
Soyio almacena el estado actualizado de todos los consentimientos en un [Agreement](../../integration-guide/general-concepts#agreement) por usuario. Este agreement es la fuente de verdad que determina qué permisos tiene cada usuario para el uso de sus datos.
...
- [**Agreements**](../../integration-guide/general-concepts#agreement): Estado consolidado y versionado de todos los consentimientos de un usuario.
- [**Evidence**](../../integration-guide/evidence-traceability): Evidencia de la acción realizada por el usuario o la empresa asociada a cada modificación del agreement.
...
- [**Company**](../../integration-guide/company-configuration): Identificador único de la empresa en el sistema Soyio.
...
- **Usos específicos**: Los consentimientos se otorgan para propósitos específicos (marketing, análisis, uso esencial, etc.). Revisa la [taxonomía](../../integration-guide/taxonomy) para conocer los usos de datos disponibles.
- **Datos específicos**: Cada consentimiento autoriza el uso de categorías específicas de datos (información de contacto, datos de navegación, etc.). Revisa la [taxonomía](../../integration-guide/taxonomy) para conocer las categorías de datos disponibles.
...
- **Canal** (`channel`): Cómo se capturó el consentimiento (`digital`, `phone_call`, `in_person`)
- **Plantilla**: Qué versión de plantilla se utilizó
- **Metadata**: Información contextual adicional asociada a la acción de consentimiento
