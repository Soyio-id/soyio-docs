...
Usa el campo `metadata` para asociar información contextual a la acción de consentimiento (identificadores de sesión, campaña, versión de formulario, etc.). Consulta la [guía de integración sin SDK](./consent-api#flujo-de-metadata) para más detalles sobre cómo funciona el flujo de metadata.
:::
