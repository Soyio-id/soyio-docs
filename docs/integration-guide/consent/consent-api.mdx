...
Si el usuario otorgó (o revocó) varios consentimientos en la misma sesión, registra todos en una sola llamada con el [endpoint de creación de commit de consentimientos](../../api/resources/create-consent-commit.api.mdx). Esto genera una única versión del acuerdo del usuario (`Agreement`) y una sola evidencia.

```json title="POST /api/v1/consent_commits"
{
    "user_reference": "user_12345", // Opcional
    "entity_id": "<entity_token>",  // Opcional
