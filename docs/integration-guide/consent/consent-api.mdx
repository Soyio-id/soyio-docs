...
# Captura consentimientos vía API

La **integración vía API** permite crear `action_token`s directamente desde tu backend, sin necesidad de instalar el SDK en el frontend.
Es la opción ideal si:
- Ya cuentas con tu propia interfaz o lógica de consentimiento.
- No deseas usar componentes embebidos.
