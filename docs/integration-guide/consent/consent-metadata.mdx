...
El campo `metadata` te permite asociar información contextual libre a cada acción de consentimiento (`ConsentAction`). Es un objeto JSON con un tamaño máximo de 8 KB.
...
Tienes la opción de enviar `metadata` en **dos momentos** del flujo. Soyio fusiona ambos objetos automáticamente en el `ConsentAction` resultante:
