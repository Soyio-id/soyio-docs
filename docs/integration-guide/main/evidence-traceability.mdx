...
Existen distintos tipos de evidencia según el módulo o proceso al que se asocie. Para más información sobre la estructura de los objetos de evidencia, consulta la [API Reference](/docs/api/resources/schemas/evidence-schema).
