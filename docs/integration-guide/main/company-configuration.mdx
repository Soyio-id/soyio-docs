...
Configura la información general y los parámetros de seguridad de tu organización dentro de Soyio.
Puedes realizar los cambios desde el dashboard administrativo o mediante la API de configuración.
...
:::info[Tip]
Puedes sobreescribir el color principal usando el parámetro `appearance` de cada componente.
:::
