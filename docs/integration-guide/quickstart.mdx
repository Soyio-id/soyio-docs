...
Esta guía te ayudará a comenzar con la integración de Soyio en tu aplicación. Soyio ofrece tres productos principales:
...
1. Explora la documentación detallada de nuestros productos:
   - [Disclosure](./products/disclosure.mdx)
   - [Signature](./products/signature.mdx)
   - [Authentication](./products/authentication.mdx)

2. Revisa los conceptos fundamentales:
   - [Verificación de Identidad](./concepts/verification.md)
   - [Consentimiento](./concepts/consent.md)
   - [Agreements](./concepts/agreement.md)

3. Consulta la [documentación de la API](../api/intro.md) para más detalles sobre los endpoints disponibles.
