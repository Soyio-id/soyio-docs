...
export default function SequenceDiagram({ actors, actions }: Props) {
    ...
    if (reactFlowInstance.current) {
      ...
      setTimeout(() => {
        reactFlowInstance.current?.fitView({
          padding: 8,
          minZoom: isFullscreen
            ? MIN_ZOOM_LEVEL_FULLSCREEN
            : MIN_ZOOM_LEVEL_NORMAL,
  ...
  return (
    <div
      ...
      data-sequence-actors={JSON.stringify(actors)}
      data-sequence-actions={JSON.stringify(actions)}
